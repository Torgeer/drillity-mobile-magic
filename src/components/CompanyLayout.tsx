...
export const CompanyLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      {/* Sidebar - Desktop */}
      <aside className={cn("fixed inset-y-0 left-0 z-40 hidden w-[240px] border-r lg:block", theme === "light" ? "bg-white" : "bg-sidebar-background")}>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <aside className={cn("fixed top-14 left-0 right-0 border-b shadow-lg", theme === "light" ? "bg-white" : "bg-sidebar-background")}>
