      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardContent className="space-y-8">
          ...
          <div className="bg-sidebar rounded-lg p-4 space-y-2">
            <h4 className="font-semibold text-sidebar-foreground">Benefits of the installed app:</h4>
            <ul className="space-y-1 text-sm text-sidebar-foreground/80">
              <li>✓ Works offline</li>
              <li>✓ Faster loading</li>
              <li>✓ Own icon on home screen</li>
              <li>✓ Fullscreen mode without browser bars</li>
            </ul>
          </div>
